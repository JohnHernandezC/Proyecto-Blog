...
SECRET_KEY = 'django-insecure-u%ugi)(oco)%@ck$qprxxcad-z=1l4se7h1+!__xpemexedc@)'
...
INSTALLED_APPS = [
    ...
    'Aplicaciones.blog',
    'import_export',#app de terceros para importar y exportarla informaciond e un modelo a diferentes formatos
    'ckeditor',#anadir un formato tipo word a nuestros modelos 
]
